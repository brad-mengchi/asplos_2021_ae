...
public:
  ...
  __noinline__ __host__ __device__ void set_incoming(int idx, CellBase *cell) {
      assert(cell != nullptr);
      this->incoming[idx] = cell;
  }
  ...
  __noinline__ __host__ __device__ void set_outgoing(int idx, CellBase *cell) {
      assert(cell != nullptr);
      this->outgoing[idx] = cell;
  }
  ...
  __noinline__ __host__ __device__ void set_target() { this->is_target = true; }
...
public:
  ...
  __noinline__ __host__ __device__ int get_velocity() { return this->velocity; }
...
public:
  ...
  __noinline__ __host__ __device__ int Baseget_phase_time() {
      return phase_time;
  }
  ...
  __noinline__ __host__ __device__ void set_phase(int ph) { this->phase = ph; }
...
public:
  __device__ __host__ void dummy() {}
  __device__ __host__ __noinline__ TrafficLight() {classType = 1;}
